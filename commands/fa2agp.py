...
def generate_agp(input_file, output_file, gap_size, contig_prefix):
    """
...
def run(args):
    if args.min_gap_size == 0:
        ...
        generate_agp(args.input_file, args.output_file, args.min_gap_size, args.contig_prefix)
